    ...
    <div class="row">
        <div class="col-md-3">
            <div class="input-group mb-3">
                ...
                <input required maxlength="25" type="text" class="form-control" placeholder="BancoName" id="nombre" name="nombre" aria-label="Username" aria-describedby="basic-addon1">
            </div>
        </div>
     </div>
